...
- `ctx/product/` — бизнес-описание продукта; основа смыслов, которые агент поддерживает.
...
- `../../ctx/architecture/overview.md` — обзор архитектуры узла связи и правила согласования с окружением.
