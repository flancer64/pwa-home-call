# Отчёт: продуктовый контекст

## Цель
Уточнить корпус `ctx/product`, приведя описания к единым инвариантам (две стороны, равноправие, нейтральная ссылка, декларация доступа), убрать технологические маркеры и обеспечить компактность в рамках инструкции.
