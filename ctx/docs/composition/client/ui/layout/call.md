...
- Макет наследует safe-area-aware оболочки `screen-shell` и `screen-card`, описанные в `ctx/docs/composition/client/ui/layout/skeleton.md`, поэтому видео и FAB-элементы соблюдают те же отступы и не описывают `env`-логику заново.
