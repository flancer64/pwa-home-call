...
Path: `./ctx/docs/composition/client/ui/patterns/style.md`
...
- `../layout/skeleton.md` — трёхзонная структура, на которую опирается тема.
- `../layout/call.md` — активный макет с FAB-панелью и зонами, оформленными через эту тему.
- `./toast-layer.md` — слой тостов, единственный источник ошибок и статусов в интерфейсе.
- `../components/style.md` — компонентные уточнения палитры и состояний, согласованные с этой темой.
