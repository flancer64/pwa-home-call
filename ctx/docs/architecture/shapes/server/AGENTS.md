...
Path: `./ctx/docs/architecture/shapes/server/AGENTS.md`
...
- **Хранитель сеанса** удерживает `sessionId` на протяжении жизненного цикла, связывает события с контекстом и очищает его после завершения, соблюдая stateless-инвариант из `ctx/docs/constraints/node.md`.
