...
- **Ожидание партнёра.** Первый подключившийся клиент остаётся в состоянии `waiting`, демонстрируя, что пространство логически открыто и ждёт второго участника; интерфейс остаётся нейтральным, не обозначая «принимающего» или «звонящего».
...
- **Активный контекст.** Сеанс считается активным после установления обоих WebSocket-клиентов и подтверждения ICE-кандидатов, при этом оба участника делят один и тот же контекст без дополнительных канонов.
