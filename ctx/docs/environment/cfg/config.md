...
> Реализационные ограничения на `sessionId`, хранение и ограниченный сигналинг описаны в `ctx/docs/constraints/node.md`; текущая конфигурация `.env` поддерживает их без дублирования архетипов.
