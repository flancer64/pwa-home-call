...
> Особые ограничения на `sessionId` и отсутствие персональных данных перенесены в `ctx/docs/constraints/node.md`; конфигурация Apache лишь проксирует необходимые маршруты.
...
- `../../../architecture/overview.md` — обзор архитектуры узла связи и её привязки к окружениям.
