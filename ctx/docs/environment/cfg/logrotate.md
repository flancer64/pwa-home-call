...
> Ограничения на логирование и технические метки `sessionId` теперь описаны в `ctx/docs/constraints/conventions.md` и `ctx/docs/constraints/node.md`; logrotate занимается их безопасным хранением.
