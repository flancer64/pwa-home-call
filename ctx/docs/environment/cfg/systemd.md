...
> Инварианты автозапуска, ограниченного состояния и минимальной телеметрии закреплены в `ctx/docs/constraints/node.md` и `ctx/docs/constraints/conventions.md`; здесь они лишь интегрируются в systemd.
