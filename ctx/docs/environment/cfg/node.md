...
> Требования к stateless-бэкенду и одиночному `sessionId` собраны в `ctx/docs/constraints/node.md`; этот документ остаётся обзором окружения.
...
- `../../../architecture/overview.md` — обзор архитектуры узла связи и привязка к окружениям.
