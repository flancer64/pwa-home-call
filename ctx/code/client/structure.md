...
Path: `./ctx/code/client/structure.md`
...
Хранение данных ограничивается метаданными (`lastCheckedVersion`, `featureFlags`, `pendingVersionUpdate`, `preferredUiFlow`, `autoToastSuppression`). sessionId и share-link существуют только в оперативной памяти или передаются через URL; постоянные хранилища очищаются `HomeCall_Web_Pwa_Cache$`/`ServiceWorker`, а подробности зафиксированы в `ctx/constraints/storage.md`.
