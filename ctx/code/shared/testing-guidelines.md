...
Path: `./ctx/code/shared/testing-guidelines.md`
...
Изменение интерфейса модуля или появление нового контракта требует обновления теста и, при необходимости, документации `ctx/code`. Ошибки сборки тестов фиксируются как нарушение контракта DI и обсуждаются в контексте ADSM.
