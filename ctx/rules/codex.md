...
Документ описывает, как контекст каталога `ctx/` управляет работой агента Codex при генерации и модификации исходного кода HomeCall.
...
с архитектурой HomeCall, принципами TeqFW и документацией используемых пакетов.
