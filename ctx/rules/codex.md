...
Документ описывает, как контекст каталога `ctx/` управляет работой агента Codex при генерации и модификации исходного кода Колобок.
...
с архитектурой Колобок, принципами TeqFW и документацией используемых пакетов.
