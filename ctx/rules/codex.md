...
Документ описывает, как контекст каталога `ctx/` управляет работой агента Codex при генерации и модификации исходного кода ДомоЗвон.
...
с архитектурой ДомоЗвон, принципами TeqFW и документацией используемых пакетов.
