...
Node.js-окружение обеспечивает выполнение серверной части **HomeCall**, включая API и канал сигналинга WebSocket.  
...
Node.js-окружение HomeCall определяет исполняемую среду для HTTP-API и сигналинга WebRTC.  
