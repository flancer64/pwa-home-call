...
Node.js-окружение обеспечивает выполнение серверной части **ДомоЗвон**, включая API и канал сигналинга WebSocket.  
...
Node.js-окружение ДомоЗвон определяет исполняемую среду для HTTP-API и сигналинга WebRTC.  
