# Принципы тестирования системы ДомоЗвон (ctx/rules/arch/testing.md)

## Назначение

Документ определяет общие принципы тестирования проекта **ДомоЗвон**.
...
Правила распространяются на **модульные тесты (unit tests)** проекта **ДомоЗвон**.
...
Документ закрепляет единый подход к тестированию проекта **ДомоЗвон**:
