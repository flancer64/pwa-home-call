# Принципы тестирования системы HomeCall (ctx/rules/arch/testing.md)

## Назначение

Документ определяет общие принципы тестирования проекта **HomeCall**.  
...
Правила распространяются на **модульные тесты (unit tests)** проекта **HomeCall**.  
...
Документ закрепляет единый подход к тестированию проекта **HomeCall**:
