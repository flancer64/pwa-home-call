...
Документ фиксирует архитектурные правила плагина **HomeCall**, интегрированного с платформой **TeqFW**.  
...
Документ задаёт действующую архитектурную декларацию плагина **HomeCall**.  
