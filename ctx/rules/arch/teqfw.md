# Проектные правила использования TeqFW в ДомоЗвон

## Назначение

Документ фиксирует архитектурные правила плагина **ДомоЗвон**, интегрированного с платформой **TeqFW**.  
...
Документ задаёт действующую архитектурную декларацию плагина **ДомоЗвон**.  
