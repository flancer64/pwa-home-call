...
Документ устанавливает конкретные правила модульного тестирования **Node.js-части** проекта **Колобок**.  
...
Документ определяет стандарты модульного тестирования Node.js-компонентов **Колобок**.
