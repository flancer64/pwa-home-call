...
Документ устанавливает конкретные правила модульного тестирования **Node.js-части** проекта **HomeCall**.  
...
4. Тесты должны подтверждать, что:
   ...
   - взаимодействие компонентов (например, Signal Server ↔ RoomManager) выполняется в пределах контракта.
...
Документ определяет стандарты модульного тестирования Node.js-компонентов **HomeCall**.
