...
> **Согласованность с продуктом:** `ctx/product/overview.md` требует, чтобы пользователь оставался в одном окне (`ready/waiting/active`) и не сталкивался с дополнительными экранами; `/reinstall.html` служит только аварийной точкой, не влияющей на логику `home/invite/call/end`, и план `ctx/agent/plan/2025/11/20251129-rules-implementation-fixes.md` описывает, как новый single-window state machine минимизирует необходимость таких страниц.
