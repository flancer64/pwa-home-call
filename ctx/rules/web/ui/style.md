...
- Интерфейс остаётся минималистичным, но теперь построен по схеме header/action/hint, чтобы сохранить одинаковое визуальное впечатление на всех экранах.
...
- Цветовая палитра нейтральная: акцент применяется только к основному действию, остальные кнопки выполнены в мягких тонах и визуально не конкурируют с ним.
