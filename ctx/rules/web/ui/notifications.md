...
Toast-уведомления Колобока передают единственную, краткую информацию: готовность ссылки, копирование, ошибки медиа и соединения. Они работают поверх минимального UI без лишних панелей, чтобы поддерживать поток «нажал кнопку — получил результат».
