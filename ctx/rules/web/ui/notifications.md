...
Система toast-уведомлений обеспечивает краткие визуальные сообщения о результатах действий и изменениях состояния в приложении HomeCall.  
...
Toast-уведомления — минимальный, автономный и предсказуемый механизм обратной связи в HomeCall.
