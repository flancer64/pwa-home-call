...
Этот документ фиксирует обновлённую компоновку с высокими контрастами и понятным ритмом для всех экранов Связиста (`home`, `invite`, `call`, `end`). Цель — обеспечить читаемость, очевидность действий и щедрое пространство, чтобы пользователь мог сосредоточиться на одной крупной кнопке.
