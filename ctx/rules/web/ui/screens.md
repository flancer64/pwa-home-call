...
Этот документ описывает экранный контур браузерного приложения ДомоЗвон, определённого в `app.md`.

## Назначение

Документ определяет минимальный набор пользовательских экранов **ДомоЗвон PWA**, достаточный для установления видеосвязи 1-на-1.  
...
Скелет интерфейса ДомоЗвон включает четыре состояния, расширенные требованиями к UX первого входа и управлению разрешениями.  
...
См. также `ctx/rules/web/app.md` — обзорный документ браузерного приложения ДомоЗвон.
