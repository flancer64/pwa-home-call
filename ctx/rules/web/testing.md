...
**Тесты веб-приложения Колобок не имеют права использовать статические импорты проектных модулей.  
...
Документ определяет правила модульного тестирования **браузерной части** проекта **Колобок**.
...
Документ фиксирует строгие и однозначные правила тестирования веб-компонентов Колобок,
