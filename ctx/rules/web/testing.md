...
**Тесты веб-приложения ДомоЗвон не имеют права использовать статические импорты проектных модулей.  
...
Документ фиксирует строгие и однозначные правила тестирования веб-компонентов ДомоЗвон,
