...
**Тесты веб-приложения Связист не имеют права использовать статические импорты проектных модулей.  
...
Документ определяет правила модульного тестирования **браузерной части** проекта **Связист**.
...
Документ фиксирует строгие и однозначные правила тестирования веб-компонентов Связист,
