...
Интерфейс HomeCall предназначен для пожилых людей, использующих смартфоны и компьютеры.  
Основные принципы:
...
Эти принципы обязательны для всех экранов (`enter`, `lobby`, `call`, `end`), а также для экранов с запросами разрешений.
