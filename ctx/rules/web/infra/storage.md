...
| **Ui**     | предоставляет пользователю средства сохранения и очистки данных;        |
...
- `ctx/product/scenarios/local-storage.md` — пользовательский сценарий «Работа с локальными данными».
