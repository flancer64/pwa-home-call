# Браузерное приложение проекта HomeCall (`ctx/rules/web/app.md`)

## Назначение

Документ описывает **поведение браузерного приложения HomeCall** как целостной системы.  
...
Фронтенд HomeCall — это единое браузерное приложение, управляемое внутренним механизмом состояний.  
