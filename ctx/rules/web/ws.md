...
Ключевые архитектурные принципы событийного обмена и маршрутизации сигналинга описаны в `ctx/rules/web/net.md`.  
...
- `./net.md` — перевод WebSocket-сообщений в события `net:*`.
