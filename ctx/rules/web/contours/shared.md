...
Этот документ описывает **Shared** — набор кросс-контурных сервисов браузерного слоя Связист, которые организуются через `@teqfw/di` и доступны другим контурам без использования шины событий.
