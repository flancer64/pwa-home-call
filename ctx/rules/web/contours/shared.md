...
Этот документ описывает **Shared** — набор кросс-контурных сервисов браузерного слоя Колобок, которые организуются через `@teqfw/di` и доступны другим контурам без использования шины событий.
