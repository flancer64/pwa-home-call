...
Документ определяет состав и назначение файлов фронтенд-части **ДомоЗвон**, реализованной как статическое PWA-приложение.  
...
- `./app.md` — обзорное поведение браузерного приложения ДомоЗвон.
...
Документ задаёт базовый каркас клиентской структуры ДомоЗвон и отражает, как каталоги и файлы поддерживают контуры, описанные в `app.md`.  
