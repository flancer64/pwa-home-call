# Файловая структура фронтенда (`ctx/rules/web/structure.md`)

## Назначение

Документ определяет состав и назначение файлов фронтенд-части **HomeCall**, реализованной как статическое PWA-приложение.  
...
- Вся логика загрузки, переходов и отображения экранов сосредоточена в `app.js`.
...
Документ задаёт базовый каркас клиентской структуры HomeCall.
