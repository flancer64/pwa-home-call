...
Документ определяет состав и назначение файлов фронтенд-части **Связист**, реализованной как статическое PWA-приложение.  
...
- `./app.md` — обзорное поведение браузерного приложения Связист.
...
Документ задаёт базовый каркас клиентской структуры Связист и отражает, как каталоги и файлы поддерживают контуры, описанные в `app.md`.  
