...
Path: `ctx/composition/client/ui/components/style.md`
...
- `ctx/composition/client/ui/patterns/style.md` — корневая палитра, типографика, зальные градиенты и параметры взаимодействия. Компоненты используют её переменные (`--accent-gradient`, `--icon-accent`, `--shadow-panel`, `--panel-background` и т. д.).
