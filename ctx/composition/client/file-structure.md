...
Путь: `ctx/composition/client/file-structure.md`
...
- `web/ui/screen/` содержит шаблоны экранов, использующие те же зоны, что и документы в `ctx/composition/client/ui/screens/`.
