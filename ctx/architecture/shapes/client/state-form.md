...
Path: `./ctx/architecture/shapes/client/state-form.md`
...
- Контур не расширяет количество участников сверх двух и придерживается симметрии, указанной в `ctx/product/overview.md`.
