...
Path: `./ctx/architecture/shapes/signal/AGENTS.md`
...
- Сигнальный контур не раскрывает транспортную структуру и опирается на `ctx/constraints/session.md` для порядка.
