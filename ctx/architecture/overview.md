...
Path: `./ctx/architecture/overview.md`
...
- `shapes/client-shape.md` — форма клиентского узла;
- `shapes/server-shape.md` — форма серверного узла;
- `shapes/messaging-shape.md` — архитектурные события;
- `shapes/lifecycle-shape.md` — фазовая структура контекста;
