...
**Контекст сеанса** — область состояния, возникающая при обращении по ссылке и существующая только в рамках активного идентификатора сеанса (`ctx/product/terms.md`).

---

## Инварианты хранения

- Постоянные хранилища используются исключительно для технических метаданных и никогда не содержат идентификатор сеанса, ссылки или состоянческих параметров сеанса. Работа узла не зависит от наличия таких записей (`ctx/product/overview.md`).
