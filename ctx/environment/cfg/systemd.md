...
> Инварианты автозапуска, ограниченного состояния и минимальной телеметрии закреплены в `ctx/constraints/node.md` и `ctx/constraints/conventions.md`; здесь они лишь интегрируются в systemd.
