...
> Особые ограничения на `sessionId` и отсутствие персональных данных перенесены в `ctx/constraints/node.md`; конфигурация Apache лишь проксирует необходимые маршруты.
