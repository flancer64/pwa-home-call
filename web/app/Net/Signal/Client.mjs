...
export default class HomeCall_Web_Net_Signal_Client {
  constructor({ HomeCall_Web_Env_Provider$: env, HomeCall_Web_Logger$: logger } = {}) {
    ...
    this.sendOffer = sendOfferMessage;
    this.sendAnswer = sendAnswerMessage;
    this.sendCandidate = sendCandidateMessage;
    this.sendHangup = sendHangupMessage;
  }
}
