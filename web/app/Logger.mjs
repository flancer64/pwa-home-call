 ...
 */
export default function HomeCall_Web_Logger({ HomeCall_Web_Env_Provider$: env, HomeCall_Web_Config_RemoteLogging$: config } = {}) {
  ...
  const debug = (message, details) => record('debug', message, details);
  const info = (message, details) => record('info', message, details);
  const warn = (message, details) => record('warn', message, details);
  const error = (message, details) => record('error', message, details);
