...
- Колобок не хранит и не обрабатывает персональные данные внутри приложения, поэтому модель-поток не включает в себя имена или другие идентификаторы пользователей.
- Любая идентификация участников происходит за пределами Колобок, через канал доставки ссылки приглашения.
